...
(function() {
  var Circles = window.Circles = function(options) {
    ...
    this.fontsize_percentage = options.fontsize_percentage || 0.5;   //自己添加的，圈内字体大小的比例
  ...
  Circles.prototype = {
    ...
    _generateText: function() {
      var html =  '<div class="' + this._textWrpClass + '" style="position:absolute; top:0; left:0; text-align:center; width:100%;' +
        ' font-size:' + this._radius * this.fontsize_percentage + 'px; height:' + this._svgSize + 'px; line-height:' + this._svgSize + 'px;">' + 
